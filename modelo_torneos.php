...
function storeMatch(){
  ...
  for($i=0;$i<count($torneos);$i++){
    if($torneos[$i]["id"]==$idTorneo){//Encontrando el torneo.
      if($round=="r1"&&count($torneos)<16){//Ronda 1
        ...
        $torneos[$i]["r1Matches"][]=[
          ...
          "re1"=>$re1,
          "re2"=>$re2,
          "statsE1"=>$_POST['stats1'],
          "statsE2"=>$_POST['stats2']
        ];
          $torneosJSON=json_encode($torneos);
          file_put_contents("torneos.json",$torneosJSON);
      }
      elseif ($round=="r2"&&count($torneos)<8) {//Ronda 2
        if ($_POST['win']="equipo1"){
          $re1="w";
          $re2="l";
          $torneos[$i]["ganadores"][]=$_POST['equipo1'];
      ...
      elseif ($round=="semi"&&count($torneos)<4){//Semifinal
        if ($_POST['win']="equipo1"){
          $re1="w";
          $re2="l";
          $torneos[$i]["ganadores"][]=$_POST['equipo1'];
      ...
      elseif($round=="final"&&count($torneos)<2) {//Final
        if ($_POST['win']="equipo1"){
          $re1="w";
          $re2="l";
          $torneos[$i]["ganadores"][]=$_POST['equipo1'];
      ...
      else {//Fallo cuando se registran más partidas de las permitidas.
        echo "Error";
      }
    }
  }
