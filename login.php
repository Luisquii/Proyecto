...
<head>
    ...
    <body class="align">
        ...
        <div class="grid">
          ...
          <form action="./control_formulario.php?opcion=1" method="POST" class="form login">
            ...
            <div class="form__field">
              ...
              <input id="login__username" type="text" name="gamertag" class="form__input" placeholder="Usuario" required>
            </div>
        ...
        <footer>
  		...
  		Luis Quiroga A00513223 -
  		Josué Valdivia A00398731 -
  		Luis Garcia A01350241<br/>
